<template>
  <div>
    <iframe ref="sbplayer" :style="style" :src="src" scrolling="no" border="0" frameborder="no" framespacing="0"
      :allowfullscreen="allowfullscreen" :sandbox="sandbox">
    </iframe>
  </div>
</template>
...
import { bilibili as BILIBILI } from "@temp/SmplayerOptions.json"
