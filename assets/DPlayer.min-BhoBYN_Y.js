import{g as ko,c as Bo}from"./commonjsHelpers-Cpj98o6Y.js";var lt={exports:{}};(function(st,Lo){(function(He,Oe){st.exports=Oe()})(self,()=>(()=>{var He={916:(u,v,f)=>{var z=f(471);u.exports=function(I){var x,p="",C=(I=I||{}).video,B=I.options,y=z.$escape,L=I.tran,O=I.icons,S=I.index,D=z.$each;return I.$value,I.$index,p+=`<div class="dplayer-mask"></div>
...
`,`
`),"color: #fadfa3; background: #030307; padding:5px 0;","background: #fadfa3; padding:5px 0;");const Co=wo})(),un.default})())})(lt);var So=lt.exports;const Io=ko(So),qo=Object.freeze(Object.defineProperty({__proto__:null,default:Io},Symbol.toStringTag,{value:"Module"}));export{qo as D};
