import{c as kr,g as Br}from"./commonjsHelpers-Cpj98o6Y.js";var An={exports:{}},st;function Sr(){return st||(st=1,function(pt,zr){(function(_e,Oe){pt.exports=Oe()})(self,()=>(()=>{var _e={916:(A,v,h)=>{var z=h(471);A.exports=function(I){var x,p="",C=(I=I||{}).video,B=I.options,y=z.$escape,L=I.tran,O=I.icons,S=I.index,D=z.$each;return I.$value,I.$index,p+=`<div class="dplayer-mask"></div>
...
<button class="dplayer-mobile-play">
    `,p+=O.play,p+=`
</button>`}},568:(A,v,h)=>{var z=h(471);A.exports=function(I){var x="",p=(I=I||{}).enableSubtitle,C=I.subtitle,B=I.current,y=I.airplay,L=I.pic,O=z.$escape,S=I.screenshot,D=I.preload,j=I.url;return p=C&&C.type==="webvtt",x+=`
<video
    ...
    `),x+`
</video>`}},49:(A,v,h)=>{h.d(v,{Z:()=>C});var z=h(415),I=h.n(z),x=h(352),p=h.n(x)()(I());p.push([A.id,`:root {
...
[aria-label][data-balloon-pos] {
  ...
  [aria-label][data-balloon-pos][data-balloon-length="fit"]:after {
    width: 100%; }
`],sourceRoot:""}]);const C=p},685:(A,v,h)=>{h.d(v,{Z:()=>D});var z=h(415),I=h.n(z),x=h(352),p=h.n(x),C=h(49),B=h(80),y=h.n(B),L=new URL(h(831),h.b),O=p()(I());O.i(C.Z);var S=y()(L);O.push([A.id,`@keyframes my-face {
  2% {
