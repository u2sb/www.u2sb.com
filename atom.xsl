<?xml version="1.0" encoding="UTF-8"?><xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:atom="http://www.w3.org/2005/Atom" xmlns:html="http://www.w3.org/TR/REC-html40"><xsl:output method="html" version="1.0" encoding="UTF-8" indent="yes"/><xsl:template match="atom:feed"><html xmlns="http://www.w3.org/1999/xhtml"><head><title>Atom Feed</title><meta http-equiv="Content-Type" content="text/html; charset=utf-8"/><meta name="viewport" content="width=device-width, initial-scale=1.0;"/><style>
          :root {
            --c-bg: #f8f8f8;
            --c-bg-elv: #fff;
            --c-text: #2c3e50;
          ...
          footer {
            ...
            text-align: center;
                  ...
                  Visit
                </a><span><xsl:if test="atom:rights"><label for="copyright-{$feed-index}">Copyright:</label><span id="copyright-{$feed-index}"><xsl:value-of select="atom:rights"/></span></xsl:if></span></div></div></xsl:for-each></div><footer>
